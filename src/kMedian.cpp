...
std::vector<element> kMedian(std::vector<int> seq, std::vector<int> card, int step, int windowSize,int clusterNum, int rawDataSize, std::vector<element> centroidIn, bool prevCentroid); //Function that calculates the kMedian
